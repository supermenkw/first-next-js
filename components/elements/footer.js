...
export default function Footer() {
  ...
  return (
    <Row className='bg-black p-0 m-0 gx-0 gy-0 footer-container' style={{ minHeight: '99px' }}>
      <Col md={5} className='ps-4 pt-4 pe-4 pb-4 d-flex justify-content-center align-items-center'>
      ...
      <Col md={7} className='text-white ps-4 pt-4 pe-4 pb-4 d-flex justify-content-center align-items-center'>
